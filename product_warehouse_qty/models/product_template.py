...
class ProductTemplate(models.Model):
    ...
    stock_product_tmpl_location_ids = fields.One2many(
            comodel_name='stock_product_location',
            inverse_name='product_tmpl_id',
            string='Location Stock '
    )

    stock_product_tmpl_warehouse_ids = fields.One2many(
    ...
    def copy(self, default=None):
        ...
        default['stock_product_tmpl_location_ids'] = []
        default['stock_product_tmpl_warehouse_ids'] = []
